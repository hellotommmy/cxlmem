...
value "initial1"
value "flat_map system_nexts [initial1]"
value "flat_map system_nexts (system_nexts initial1)"
value "flat_map system_nexts (flat_map system_nexts (system_nexts initial1))"
end
